const LoaderBar = document.getElementById("ilbiibdb-downloading-in");
            ...
            switch (ext) {
                ...
                case 'png':
                    ...
                    img.addEventListener("load", function () {
                        ...
                        LoaderBar.style.width = "calc(" + Percent + "% - 4px)";
                        UI_LoadingText.innerText = "Download in progress. [" + that.successCount + "/" + maxNumLoad + "] " + Percent + "%";
